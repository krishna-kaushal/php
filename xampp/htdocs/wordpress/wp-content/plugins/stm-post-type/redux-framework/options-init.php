    ...
    Redux::setSection($opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'text-align' => false,
                'preview' => false,
                'output' => array('#header .header_default, #header .header_default .stm_header_links a, #header .header_default .header_main_menu_wrapper a, #header .header_default .header_top_bar a, #header .header_default .header_top_bar'),
            ),
            array(
                ...
                'text-align' => false,
                'preview' => false,
                'output' => array('#header .header_default .stm_header_links a:hover, #header .header_default .header_main_menu_wrapper a:hover, #header .header_default .header_top_bar a:hover'),
            ),
