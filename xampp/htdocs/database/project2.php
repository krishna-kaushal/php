...
<div class="container">
  ...
  <form action="project2.php" method="post">
    <label class="radio-inline">
      <input name="button" value="name" type="radio" name="optradio" checked> Name
    </label>
    <label class="radio-inline">
      <input name="button" value="roll" type="radio" name="optradio"> Roll No.
    </label>
    <label class="radio-inline">
      <input name="button" value="marks" type="radio" name="optradio"> Marks

    </label>

<br><br>
<input type="text" class="input" name="studentName" placeholder="Enter Name..." autocomplete="off"><br>
    <br><br><input type="submit" value="Submit" name="btn" class="button button-1">
<br><br><select name="roll">
...
<?php
	...
	$studentRoll = $_POST['studentName'];
	$q = "select * from student where roll='$studentRoll'";
	$rs = mysql_query($q) or die("Query Not Found");
...
else if($button == "marks") {
	$studentMarks = $_POST['studentName'];
	$q = "select * from student where marks='$studentMarks'";
	$rs = mysql_query($q) or die("Query Not Found");
